...
rust_library(
    ...
    deps = [
        ...
        "@raze__wasm_bindgen_anyref_xform__0_2_40//:wasm_bindgen_anyref_xform",
        "@raze__wasm_bindgen_shared__0_2_40//:wasm_bindgen_shared",
        "@raze__wasm_bindgen_threads_xform__0_2_40//:wasm_bindgen_threads_xform",
        "@raze__wasm_bindgen_wasm_interpreter__0_2_40//:wasm_bindgen_wasm_interpreter",
    ],
    rustc_flags = [
        "--cap-lints=allow",
    ],
